...
public class BasicDocument extends Document 
{
	...
	public static void main(String[] args)
	{
		...
		testCase(new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
		testCase(new BasicDocument("Counting"), 2, 1, 1);
		
		//Benchmarking
		BasicDocument test = new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad.");
		long beginTime = System.nanoTime();
		double fleschScore = test.getFleschScore();
