...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String stringToProcess = getStringFromFile(textfile, numToCheck);
			long startTime = System.nanoTime();
			int i = 0;
			while(i < trials){
				BasicDocument test = new BasicDocument(stringToProcess);
				test.getFleschScore();
				i += 1;
			}
			...
			i = 0;
			while(i < trials){
				EfficientDocument testEfficient = new EfficientDocument(stringToProcess); 
				testEfficient.getFleschScore();
				i += 1;
			}
